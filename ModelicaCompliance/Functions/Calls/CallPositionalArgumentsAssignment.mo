...
model CallPositionalArgumentsAssignment
  ...
  annotation (
    ...
    Documentation(
      info = "<html> Tests assignment to positional input argument of a function call .</html>"));

end CallPositionalArgumentsAssignment;
