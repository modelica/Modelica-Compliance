...
model CallMultiResultsWithOmittedOutput1
  ...
  annotation (
    ...
    Documentation(
      info = "<html> Tests assignment to omitted left hand side component reference to discard on of the outputs from a function call.</html>"));

end CallMultiResultsWithOmittedOutput1;
