...
model GlobalLookupEncapsulatedElement
  ...
  .ModelicaCompliance.Scoping.NameLookup.Global.GlobalLookupEncapsulatedElement.M m;
...
end GlobalLookupEncapsulatedElement;
