...
equation
  ...
  assert(realAlmostEq(e[1, 2], 0.0), "The element of e[1, 2] must be 0.0");
  assert(realAlmostEq(e[2, 1], 0.0), "The element of e[2, 1] must be 0.0");
  assert(realAlmostEq(e[2, 2], 1.0), "The element of e[2, 2] must be 1.0");
