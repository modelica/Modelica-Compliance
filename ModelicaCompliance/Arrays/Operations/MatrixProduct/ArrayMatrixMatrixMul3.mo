...
equation 
  ...
  assert(realAlmostEq(r[1, 3], 12.0), "The element of r[1, 3] must be 12.0");
  assert(realAlmostEq(r[2, 1], 5.0), "The element of r[2, 1] must be 5.0");
  assert(realAlmostEq(r[2, 2], 10.0), "The element of r[2, 2] must be 10.0");
  assert(realAlmostEq(r[2, 3], 15.0), "The element of r[2, 3] must be 15.0");
  assert(realAlmostEq(r[3, 1], 6.0), "The element of r[3, 1] must be 6.0");
  assert(realAlmostEq(r[3, 2], 12.0), "The element of r[3, 2] must be 12.0");
  assert(realAlmostEq(r[3, 3], 18.0), "The element of r[3, 3] must be 18.0");
