...
model PotentialRootInNonParametricIf
...
equation 
  ...
  annotation (
    ...
    Documentation(
      info = "<html>Checks that Connections.potentialRoot is not allowed to be
        used inside if-equations with non-parametric conditions.</html>"));
end PotentialRootInNonParametricIf;
