...
equation 
  ...
  Connections.potentialRoot(m.c1.theta, 1);

  annotation (
    __ModelicaAssociation(TestCase(shouldPass = true, section = {"9.4.1"})),
    experiment(StopTime = 0.01),
    Documentation(
      info = "<html>Tests the Connections.potentialRoot operator with priority.</html>"));
end PotentialRootPriority;
